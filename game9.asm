...
MAIN:		li	a1, 55
        	li      a2, 39		# profundidade arbitraria que coloquei para teste
        	li	a3, 44
...
LOOP0:		lw      t0, HEAP_ADDR
        	...
        	addi	t4, t4, 4
        	blt     a0, t2, LOOP0
PRINT_CHAR:	li	t2, 256		# 4*8*8 comparador
		li	t6, 32
		slli	t3, a2, 8
		add	a0, t3, a1
		slli	a0, a0, 2	# multiplica por 4 pois se trata de um endereco de word
