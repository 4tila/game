...
TYPELOAD:	.word 0x0, 0x1, 0x1, 0x1, 0x1, 0x1
...
#       	s2 = type of item he has (0 means no item)
#      		s3 = map address
#		s4 = number of lives
#		TODO  adicionar item especial que permite troca de fase
#		
...
SETUP:		li	a1, -1 # cant jump at beginning
		li	a2, 1
		li	a3, 2
		li	a5, 320
		li	a6, 0x12c00
...
LOAD:		la	t1, LEVEL
		lw	t1, (t1)
		beq	t1, zero, LEVEL0
LEVEL0:		li	s4, 4 # Sao 3 vidas, mas eu coloco 4 por causa da comparacao para decidir se eh game_over
		li	a0, 0x2800
		la	s3, MAP
		la	s5, LOADRANGE
		mv	a4, s5
...
ATTACK: 	li	t0, 4 # counter of characters
		...
		addi	s5, s5, 16	# Having Item 1 increases the range of shot
NOITEM1:	la	s6, POSITIONX
		la	s7, POSITIONY
		la	s8, ALIVE
		lw	t4, (s6)
		lw	t5, (s7)
